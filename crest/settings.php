<?php
define('C_REST_CLIENT_ID','local.682c77488119c0.09295092');//Application ID
define('C_REST_CLIENT_SECRET','3sDfK9SxQCYXV2CQYRQj0xpdiliOJk51QRZMu4PFkUfWrqeMff');//Application key
// or
...
define('C_REST_OAUTH_URL', 'http://oauth.local/'); //url for oauth