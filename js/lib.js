...
BX24.redirect = function (url, cb)
{
	sendMessage('redirect', {target: url.toString()}, cb);
};

BX24.openSliderByConfig = function (params, cb)
{
	sendMessage('openSliderByConfig', params, cb);
};
